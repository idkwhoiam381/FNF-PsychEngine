...
{
	public static var curModVer:String = '1.0';
	public static var kadeEngineVersion:String = '1.5.4'; //This is also used for Discord RPC
	...
	public static var mouseGraphic:BitmapData = BitmapData.fromFile('assets/preload/images/mouse.png');
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, curModVer + ' ' + daRealEngineVer + " Vs XPumpkingGuyX", 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("Comic Sans MS Bold", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Psych Engine v" + kadeEngineVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("Comic Sans MS Bold", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
